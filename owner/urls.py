...
from .views import (
    ...
    AboutUsView, GetLatestLocationView,enter_venue,exit_venue
)
...
urlpatterns = [
    ...
    path('enter/<int:owner_id>/', enter_venue, name='enter_venue'),
    path('exit/<int:owner_id>/', exit_venue, name='exit_venue'),
